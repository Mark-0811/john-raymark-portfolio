...
const flagshipProjects = [
  ...
  {
    no: '03', title: 'Dexterton WorkHub', subtitle: 'Operations and work-management platform',
    description: 'A role-aware work hub that brings requests, approvals, projects, tasks, workflows, and audit visibility into one focused workspace for teams.',
    screenshots: [
      { src: assetPath('/projects/workhub/dashboard.png'), label: 'Dashboard' },
      { src: assetPath('/projects/workhub/requests.png'), label: 'Requests & approvals' },
    ],
    tags: ['Laravel', 'Vue', 'PostgreSQL', 'Redis', 'Docker'],
  },
]

const projects = [
  { no: '04', title: 'Meeting Transcriber', subtitle: 'Desktop transcription and diagnostics', challenge: 'Meeting notes were difficult to capture consistently across different audio devices and languages.', features: 'Dual audio capture, English/Tagalog transcription workflows, diagnostics, themes, and a Windows desktop interface.', impact: 'Created a practical productivity tool for turning live conversations into searchable notes.', tags: ['C#', 'Windows', 'Audio', 'Transcription'], repo: 'https://github.com/Mark-0811/MeetingTranscriber' },
  { no: '05', title: 'Odoo Workflow Automation', subtitle: 'ERP approval and operations tooling', challenge: 'Business teams needed ERP workflows that reflected real approval paths and operational handoffs.', features: 'Python models, XML views, PostgreSQL-backed rules, role-aware actions, and workflow automation.', impact: 'Delivered focused enterprise tools that fit daily operations and remain maintainable as processes evolve.', tags: ['Odoo', 'Python', 'PostgreSQL'], repo: 'https://github.com/Mark-0811/odoo' },
  { no: '06', title: 'My ERP System', subtitle: 'Procurement and inventory foundation', challenge: 'Procurement teams needed one place to manage requests, purchasing, inventory, and receiving activity.', features: 'Flask modules, Mazer-based interface, inventory workflows, procurement records, and operational reporting.', impact: 'Established a modular foundation for connected purchasing and inventory operations.', tags: ['Flask', 'Python', 'Inventory', 'Procurement'], repo: 'https://github.com/Mark-0811/my_erp_system' },
]
  ...
  return (
    <main>
      ...
      <section id="contact" className="contact-section section-shell">
        ...
        <div className="contact-links"><a href="https://github.com/Mark-0811" target="_blank" rel="noreferrer"><GitBranch size={17} /> GitHub</a><a href={`mailto:${email}`}><Mail size={17} /> Email</a></div>
      </section>
